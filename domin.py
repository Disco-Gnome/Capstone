...
df_for_domin = pums_data[['AGEP', 'AGE_SQUARED', 'FOD1P', 'HISP', 'INDP', 'log_WAGP', 'NOC', 'OCCP', 'SEX', 'STATE', 'WKHP', 'WKWN']]
...
for col in ['FOD1P', 'HISP', 'INDP', 'OCCP', 'SEX', 'STATE']:
...
# Init dataset for domin
df_for_domin = pums_data[['AGEP', 'AGE_SQUARED', 'FOD1P', 'HISP', 'log_WAGP', 'NOC', 'SEX', 'STATE', 'WKHP', 'WKWN']]

# Convert categorical variables to category dtype
for col in ['FOD1P', 'HISP', 'SEX', 'STATE']:
    df_for_domin[col] = df_for_domin[col].astype('category')
...
# Garbage collect
del(df_for_domin, group_defs, group_features, X_temp, y_temp, group_name, cols, X_group, model, group_pred, X_reduced, dominance_reg1, dominance_df1)
